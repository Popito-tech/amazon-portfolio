...
import sliderImg_1 from '../images-ama-typscript/slider/sliderImg_1.jpg'
import sliderImg_2 from '../images-ama-typscript/slider/sliderImg_2.jpg'
import sliderImg_3 from '../images-ama-typscript/slider/sliderImg_3.jpg'
  ...
  return (
    <div className='relative'>
      <Carousel autoPlay infiniteLoop showStatus={false} showIndicators={false} showThumbs={false} interval={3000}>
        <div>
        <Image priority src={sliderImg_1} alt=''/>
        </div>
        <div>
